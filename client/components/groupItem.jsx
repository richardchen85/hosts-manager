...
function Header(props) {
  ...
  return (
    <header className="header">
      ...
      <div className="ctrl">
        <i
          className="iconfont i-edit"
          title="modify"
          onClick={(e) => changeStatus(!editing, index)}
        >
          &#xe606;
        </i>
        <i className="iconfont i-del" title="delete" onClick={(e) => onDelete(index)}>
          &#xe600;
        </i>
      </div>
    </header>
...
function Footer(props) {
  ...
  return (
    <footer className="ft">
      <span className="editing-btn-apply" onClick={(e) => props.handleSubmit(content, index)}>
        <i className="iconfont">&#xe603;</i>Apply
      </span>
      <span className="editing-btn-cancel" onClick={(e) => props.changeStatus(false, index)}>
        <i className="iconfont">&#xe602;</i>Cancel
      </span>
    </footer>
  );
}
